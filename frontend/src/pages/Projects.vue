...
const projects: Project[] = [
  {
    emoji: '🌦️',
    name: 'WeatherPoet',
    zh: 'Material 3 Expressive 风格的 Android 天气应用：动态主题、动画天气背景、雷达图，Kotlin + Jetpack Compose。',
  ...
  },
  {
    emoji: '🕛',
    name: 'ClockPoet',
    zh: 'Material Expressive 时钟应用：世界时钟、闹钟、计时器，像素级还原现代 Android 设计语言。',
  ...
  },
  {
    emoji: '🎬',
    name: 'WatchPoet',
    zh: '追剧清单应用：TMDB 数据源，追踪在看 / 待看 / 已看完的剧和电影，Material 3 Expressive UI。',
  ...
  },
  {
    emoji: '🎤',
    name: 'RecordPoet',
    zh: 'Material Expressive 录音应用：干净的录音与管理体验，灵感来自 Pixel Recorder。',
  ...
  },
  {
    emoji: '🗒️',
    name: 'NotesPoet',
    zh: 'Android 笔记应用：富文本格式、标签、导出导入、列表/网格视图切换。',
  ...
  },
  {
    emoji: '🔮',
    name: 'MindPoet',
    zh: '读心术小网页：经典数学把戏的纯前端实现，零依赖，300KB 不到。',
  ...
  },
  {
    emoji: '💳',
    name: 'SimpleCard',
    zh: '自托管数字商品发卡平台：Spring Boot 3 API + Next.js 16 店面，Epay/USDT 支付管线（链上验证）、风控层、完整管理后台。',
    en: 'Self-hosted digital goods delivery platform: Spring Boot 3 API + Next.js 16 storefront, Epay/USDT payment pipeline with on-chain verification, risk control, full admin panel.',
    tech: ['Java 22', 'Spring Boot', 'Next.js', 'PostgreSQL', 'Docker'],
    url: 'https://github.com/runtimepoet/simplecard',
    date: '2026-08',
  },
  {
    emoji: '🪟',
  ...
  },
  {
    emoji: '🎯',
    name: 'vuln-card',
    zh: '对 SimpleCard 的完整安全审计：未授权订单查询→卡密窃取链、默认口令/密钥陷阱、限流伪防御——含 HTTP 级复现与修复方案。',
    en: 'Full security audit of SimpleCard: unauthenticated order-query → card-key theft chain, default credential/JWT pitfalls, rate-limit bypass — with HTTP-level repro and fixes.',
    tech: ['Security', 'Spring Boot', 'IDOR', 'Audit'],
    url: 'https://github.com/runtimepoet/vuln-card',
    date: '2026-08',
  },
  {
    emoji: '✍️',
    name: 'runtimepoet · blog',
    zh: '你正在看的这个站：Vue 3 + Vite Markdown 博客，毛玻璃 UI，零依赖 Node 后端，单容器 Docker 部署。',
    en: 'This very site: a Vue 3 + Vite Markdown blog with a glassmorphism UI, zero-dependency Node backend, single-container Docker deploy.',
    tech: ['Vue 3', 'TypeScript', 'Vite', 'Node.js', 'Docker'],
